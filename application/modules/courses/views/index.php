<div id="content" class="content">
    ...
    <h1 class="page-header"><b>DATA COURSES</b></h1>
    <div class="row">
        <div class="col-xl-12">
            <div class="panel panel-inverse">
                <div class="panel-heading">
                    <h4 class="panel-title">
                        <button type="button" class="btn btn-success" data-toggle="modal" data-target="#modal_add"><b><i
                                    class="fa fa-plus"></i></b>
                            <?php echo $lang_add; ?></button>
                    </h4>
                                ...
                                <tr class="odd gradeX">
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-danger" data-toggle="modal"
                                            data-target="#modal_delete" data-id="<?= $data->id ?>"
                                            data-name=" <?= $data->name ?>">
    ...
    <!-- Vertical form modal -->
    <div id="modal_add" class="modal fade" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title"><?php echo $lang_add; ?></h5>
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                </div>

                <form action="<?= base_url() ?>courses/insert_data" method="post">
                    <div class="modal-body">
                        <div class="form-group">
                            <div class="row">

                                <div class="col-sm-6">
                                    <label><?php echo $lang_table_code; ?></label>
                                    <input type="text" name="code" placeholder="Kode MK..." class="form-control"
                                        required>
                                </div>
                                ...
                                <div class="col-sm-12">
                                    <label><?php echo $lang_table_description; ?></label>
    ...
    <div id="modal_delete" class="modal fade" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title"><?php echo $lang_delete; ?></h5>
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                </div>

                <form action="<?= base_url() ?>courses/update_data" method="post">
                    <div class="modal-body">
                        <div class="form-group">
                            <div class="row">
                                <input type="hidden" id="id" name="id">
                                <div class="col">
                                    <p>Apakah Anda yakin mau menghapus MK?</p>
                                </div>
                            </div>
                        </div>
                    </div>
