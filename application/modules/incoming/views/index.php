    ...
    <div id="modal_approve" class="modal fade" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                ...
                <form action="<?= base_url() ?>dashboard/incoming/approve_data" method="post">
                    <div class="modal-body">
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col">
                                    <p>Apakah Anda yakin approve peminjaman alat ini?</p>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div id="modal_rejected" class="modal fade" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                ...
                <form action="<?= base_url() ?>dashboard/incoming/rejected_data" method="post">
                    <div class="modal-body">
                        <div class="form-group">
                            <div class="row">
                                <input type="hidden" id="id" name="id">
