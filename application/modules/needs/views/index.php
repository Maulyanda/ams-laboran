<div id="content" class="content">
    ...
    <h1 class="page-header"><b>DATA NEEDS</b></h1>
    <div class="row">
        <div class="col-xl-12">
    ...
    <div id="modal_add" class="modal fade" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form action="<?= base_url() ?>needs/insert_data" method="post">
    ...
    <div id="modal_delete" class="modal fade" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <form action="<?= base_url() ?>needs/update_data" method="post">
                    <div class="modal-body">
                        <div class="form-group">
                            <div class="row">
                                <input type="hidden" id="id" name="id">
                                <div class="col">
                                    <p>Apakah Anda yakin mau menghapus Kebutuhan?</p>
                                </div>
                            </div>
                        </div>
                    </div>
