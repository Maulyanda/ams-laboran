<head>
	<title>MAINTENANCE APPS</title>
	<link rel="icon" type="image/png" href="<?php echo base_url('assets/img/logo/japang.png');?>">
</head>
<body>
    ...
    <div class="animation02">
        ...
        <div class="name">
            <p>APLIKASI SEDANG TIDAK BISA DIAKSES. TERIMAKASIH</p>
